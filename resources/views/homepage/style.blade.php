...
------------------------------------------------------------------*/
    ...
    :root {
        --spartan: "Tajawal", sans-serif;
        --poppins: "Tajawal", sans-serif;
        --sage-green: #D989A3;
        --warm-beige: #B88A5A;
        --cream-white: #FFF4EF;
        --soft-earth-pink: #F2B6C6;
        --deep-sage: #4B213F;
        --primary-color: <?php echo $gSetting->color_1; ?>;
        --secondary-color: <?php echo $gSetting->color_2; ?>;
        --sub-bg: <?php echo $gSetting->color_3; ?>;
        --sub-bg-two: #F7DDE6;
        --heading-color: <?php echo $gSetting->color_2; ?>;
        --paragraph: #735C68;
        --paragraph-light: rgba(255, 252, 246, 0.82);
        --span: #735C68;
        --border: #EAD1DA;
        --white: #FFF9F7;
        --black: #000000;
    ...
    * {
    ...
    body.lang-en .rtlDirection {
        direction: ltr !important;
        text-align: left;
    }

    body.lang-en .main-menu nav ul li .sub-menu,
    body.lang-en .main-menu nav ul li .sub-sub-menu {
        text-align: left;
    }
    ...
    .header-area {
        ...
        border-bottom: 1px solid rgba(75, 33, 63, 0.08);
        box-shadow: 0 18px 50px rgba(75, 33, 63, 0.06);
    ...
    .footer-two-area .logo img,
    .sidebar-area .logo img {
        max-width: 178px;
        height: auto;
    }

    .header-area .logo--header-primary {
        display: inline-flex;
        align-items: center;
        ...
        height: 74px;
        padding: 5px 8px;
        border: 1px solid rgba(217, 137, 163, 0.26);
        border-radius: 18px;
        background: rgba(255, 244, 239, 0.72);
        box-shadow: 0 14px 30px rgba(75, 33, 63, 0.08);
        overflow: hidden;
    }

    .header-area .logo--header-primary img {
    ...
    .menu-btns a.active,
    .sidebar__btns .sign-in,
    .btn-one {
        border-radius: 8px;
        background: var(--primary-color);
        color: #FFF9F7;
        box-shadow: 0 12px 28px rgba(143, 175, 139, 0.20);
    }
    ...
    .notificationBut {
        ...
        background: #FFF9F7;
        border: 1px solid #EAD1DA;
        box-shadow: 0 10px 30px rgba(75, 33, 63, 0.06);
        color: #4B213F;
    }
    ...
    .notificationBut:hover {
        background: #F7DDE6;
        color: #4B213F;
    }

    @media (max-width: 1199px) {
        .header__main > .d-flex .language-switch {
            display: none;
        }
    ...
    .search-wrap {
        ...
        cursor: url(/frontend/images/icon/cancel.png), auto;
    }
    ...
    #loading {
        background:
            linear-gradient(90deg, rgba(75, 33, 63, 0.045) 1px, transparent 1px),
            linear-gradient(180deg, rgba(75, 33, 63, 0.045) 1px, transparent 1px),
            #FFF4EF;
    ...
    .store-page-loader {
        ...
        border-radius: 8px;
        background: rgba(255, 252, 246, 0.94);
        box-shadow: 0 28px 70px rgba(75, 33, 63, 0.12);
        backdrop-filter: blur(14px);
    }

    .store-page-loader__icon {
        display: inline-flex;
        align-items: center;
        justify-content: center;
        width: 58px;
        ...
        background: #4B213F;
        color: #FFF4EF;
        box-shadow: 0 16px 32px rgba(75, 33, 63, 0.18);
        animation: storeLoaderLift 1.1s ease-in-out infinite;
    }

    .store-page-loader__icon i {
        color: #FFF4EF;
        font-size: 24px;
    }

    .store-page-loader__brand {
        margin-top: 14px;
        color: #2C1830;
        font-size: 18px;
        font-weight: 900;
    ...
    .store-page-loader__brand span {
        color: #2C1830;
    }

    .store-page-loader__bar {
        position: relative;
        width: 150px;
        height: 6px;
        margin-top: 16px;
    ...
    .store-page-loader__bar span {
        position: absolute;
        inset: 0 auto 0 0;
        width: 45%;
        border-radius: inherit;
        background: linear-gradient(90deg, #D989A3, #F2B6C6);
        animation: storeLoaderBar 1.05s ease-in-out infinite;
    }

    @keyframes storeLoaderLift {
        0%,
        100% {
    ...
    .scroll-up {
        ...
        background: #4B213F;
        box-shadow: 0 18px 36px rgba(75, 33, 63, 0.22);
        z-index: 99;
        opacity: 0;
        visibility: hidden;
    ...
    .btn-one:hover,
    .btn-one-light:hover,
    .event-five__content .event-five-btn:hover {
        color: var(--white);
    }

    .btn-one:hover::after,
    .btn-one-light:hover::after,
    .event-five__content .event-five-btn:hover::after {
        position: absolute;
        right: unset;
        left: 0;
        width: 100%;
    ...
    .header-top__wrp .info,
    .header-top-two__wrp .info {
        display: flex;
        align-items: center;
        gap: 20px;
    }

    .header-top__wrp .info a,
    .header-top-two__wrp .info a {
        transition: var(--transition);
        color: var(--paragraph-light);
    }

    .header-top__wrp .info a:hover,
    .header-top-two__wrp .info a:hover {
        color: var(--primary-color);
    }

    .header-top__wrp .info li,
    .header-top-two__wrp .info li {
        display: flex;
        align-items: center;
        gap: 8px;
    }

    .header-top__wrp .info li span,
    ...
    .header-top__wrp .socila-link li a,
    .header-top-two__wrp .socila-link li a {
        color: var(--white);
        text-align: center;
    }

    .header-top__wrp .socila-link li a:hover,
    .header-top-two__wrp .socila-link li a:hover {
        color: var(--primary-color);
    }
    ...
    .banner__video-btn .video-pulse::after,
    .banner__video-btn .video-pulse::before {
        border: 1px solid var(--primary-color);
    }
    ...
    .banner-ten__content h1 span,
    .banner-eight__content h1 span,
    .banner-five__content h1 span {
        position: relative;
        z-index: 1;
    }

    .banner-two__content h1 span img,
    .banner-ten__content h1 span img,
    .banner-eight__content h1 span img,
    .banner-five__content h1 span img {
        position: absolute;
        bottom: -5px;
        left: 50%;
        transform: translateX(-50%);
    ...
    .section-header-three h2 span {
        color: var(--heading-color);
        position: relative;
        z-index: 1;
    }

    .section-header h2 span img,
    .section-header-four h2 span img,
    .section-header-three h2 span img {
        position: absolute;
        bottom: 0;
        left: 50%;
        transform: translateX(-50%);
    ...
    .about__image .about-circle,
    .about-nine__image .about-circle {
        max-width: 298px;
        right: -10%;
        top: 50px;
        z-index: -1;
    ...
    .about-two__video-btn .video-popup,
    .choose-five__video-btn .video-popup {
        width: 60px;
        height: 60px;
        line-height: 60px;
        text-align: center;
    ...
    .courses-two__image,
    .event-five__image,
    .courses-seven__image {
        position: relative;
    }

    .courses__image .courses-price,
    .courses-six__image .courses-price,
    .courses-two__image .courses-price,
    .event-five__image .courses-price,
    .courses-seven__image .courses-price {
        position: absolute;
        bottom: -28px;
        left: 30px;
    }

    .courses__image .courses-price h5,
    .courses-six__image .courses-price h5,
    .courses-two__image .courses-price h5,
    .event-five__image .courses-price h5,
    .courses-seven__image .courses-price h5 {
        width: 56px;
        height: 56px;
        line-height: 56px;
        text-align: center;
    ...
    .courses-two__image img,
    .event-five__image img,
    .courses-seven__image img {
        border-radius: 10px;
    }

    .courses-two__image .time,
    ...
    .event__item .event-btn,
    .our-class-five__item .event-btn,
    .event-five__item .event-btn {
        padding: 5px 14px;
        border-radius: 6px;
        border: 1px solid var(--border);
        font-weight: 500;
    ...
    .event__item:hover .event-btn,
    .our-class-five__item:hover .event-btn,
    .event-five__item:hover .event-btn {
        background-color: var(--primary-color);
        color: var(--white);
        border: 1px solid transparent;
    }
    ...
    .event-details__item-left .image,
    .courses-details__item-left .image {
        position: relative;
    }

    .event-details__item-left .image .tag,
    .courses-details__item-left .image .tag {
        position: absolute;
        top: 24px;
        left: 24px;
        font-family: var(--spartan);
    ...
    .event-details__item-left .image img,
    .courses-details__item-left .image img {
        border-radius: 8px;
    }

    .event-details__item-left ul li,
    .courses-details__item-left ul li {
        display: flex;
        align-items: center;
        gap: 10px;
        text-transform: capitalize;
    ...
    .event-details__item-left ul li:not(:last-child),
    .courses-details__item-left ul li:not(:last-child) {
        margin-bottom: 20px;
    }

    .event-details__item-left ul li span,
    .courses-details__item-left ul li span {
        width: 30px;
        height: 30px;
        line-height: 27px;
        text-align: center;
    ...
    .event-details__item-right .item,
    .courses-details__item-right .item {
        padding: 30px;
        padding-bottom: 40px;
        border-radius: 10px;
        border: 1px solid var(--border);
    ...
    .event-details__item-right .item ul,
    .courses-details__item-right .item ul {
        margin-top: 20px;
        margin-bottom: 30px;
    }

    .event-details__item-right .item ul li,
    .courses-details__item-right .item ul li {
        display: flex;
        align-items: center;
        gap: 5px;
        padding: 15px 0;
    ...
    .event-details__item-right .item ul li:first-child,
    .courses-details__item-right .item ul li:first-child {
        border-top: 1px solid var(--border);
    }

    .event-details__item-right .item ul li p strong,
    .courses-details__item-right .item ul li p strong {
        font-weight: 500;
        color: var(--heading-color);
    }

    .event-details__item-right .item .price,
    .courses-details__item-right .item .price {
        width: 100%;
        display: block;
        padding: 12px;
        border: 1px solid var(--primary-color);
    ...
    .event-details__item-right .item .btn-one,
    .courses-details__item-right .item .btn-one,
    .event-details__item-right .item .btn-one-light,
    .courses-details__item-right .item .btn-one-light,
    .event-details__item-right .item .event-five__content .event-five-btn,
    .event-five__content .event-details__item-right .item .event-five-btn,
    .courses-details__item-right .item .event-five__content .event-five-btn,
    .event-five__content .courses-details__item-right .item .event-five-btn {
        width: 100%;
        text-align: center;
    }

    .event-details__item-right .item .share,
    .courses-details__item-right .item .share {
        margin-top: 20px;
        display: flex;
        align-items: center;
        justify-content: center;
    ...
    .event-details__item-right .item .share strong,
    .courses-details__item-right .item .share strong {
        color: var(--heading-color);
        font-weight: 600;
        font-family: var(--spartan);
    }

    .event-details__item-right .item iframe,
    .courses-details__item-right .item iframe {
        width: 100%;
        height: 220px;
        border-radius: 10px;
    }
    ...
    .discout-three__item h2,
    .subscribe-five__wrp h2 {
        line-height: 44px;
    }

    .discout-three__item .subscribe-now,
    .subscribe-five__wrp .subscribe-now {
        position: relative;
        z-index: 1;
    }

    .discout-three__item .subscribe-now input,
    .subscribe-five__wrp .subscribe-now input {
        width: 100%;
        padding: 15px 25px;
        border-radius: 6px;
    }

    .discout-three__item .subscribe-now .btn-one,
    .subscribe-five__wrp .subscribe-now .btn-one,
    .discout-three__item .subscribe-now .btn-one-light,
    .subscribe-five__wrp .subscribe-now .btn-one-light,
    .discout-three__item .subscribe-now .event-five__content .event-five-btn,
    .subscribe-five__wrp .subscribe-now .event-five__content .event-five-btn,
    .event-five__content .discout-three__item .subscribe-now .event-five-btn,
    .event-five__content .subscribe-five__wrp .subscribe-now .event-five-btn {
        font-size: 16px;
        text-transform: uppercase;
        font-weight: 400;
        letter-spacing: 1px;
    ...
    .gallery__image:hover .instagram-icon,
    .gallery-seven__image:hover .instagram-icon {
        position: absolute;
        top: 50%;
        left: 50%;
        transform: translate(-50%, -50%);
    ...
    .gallery-seven__image:hover::before {
        height: 100%;
    }
    ...
    .team-three__content .social-icons {
        margin-top: 10px;
        display: flex;
        align-items: center;
        justify-content: center;
    ...
    .team__content .social-icons a,
    .team-three__content .social-icons a {
        width: 40px;
        height: 40px;
        line-height: 40px;
        text-align: center;
    ...
    .team__content .social-icons a:hover,
    .team-three__content .social-icons a:hover {
        background-color: var(--primary-color);
        box-shadow: none;
        color: var(--white);
    }

    .team-two-area.extra-padding,
    .extra-padding.team-five-area,
    .extra-padding.team-four-area {
    ...
    .team-seven__item .team-four__content,
    .team-nine__item .team-four__content {
        transition: var(--transition);
    }

    .team-seven__item .team-four__content span,
    .team-nine__item .team-four__content span {
        transition: var(--transition);
    }

    .team-seven__item:hover .team-seven__image img,
    .team-nine__item:hover .team-seven__image img,
    .team-seven__item:hover .team-nine__image img,
    .team-nine__item:hover .team-nine__image img {
        border-top-left-radius: 130px;
        border-top-right-radius: 130px;
    }

    .team-seven__item:hover .team-four__content,
    .team-nine__item:hover .team-four__content {
        background-color: var(--primary-color);
    }

    .team-seven__item:hover .team-four__content h4 a,
    .team-nine__item:hover .team-four__content h4 a {
        color: var(--white);
    }

    .team-seven__item:hover .team-four__content span,
    .team-nine__item:hover .team-four__content span {
        color: var(--white);
    }
    ...
    .talk-us__item .section-header-three h5,
    .talk-us__item .section-header-four h5 {
        padding-bottom: 5px;
    }

    .talk-us__item .section-header h2,
    .talk-us__item .section-header-three h2,
    .talk-us__item .section-header-four h2 {
        font-size: 30px;
    }
    ...
    .blog__content .blog-tag,
    .blog-nine__content .blog-tag,
    .blog-two__content .blog-tag {
        position: absolute;
        top: -80px;
        left: 30px;
        background: var(--primary-color);
    ...
    .blog__content .blog-tag h3,
    .blog-nine__content .blog-tag h3,
    .blog-two__content .blog-tag h3 {
        line-height: 20px;
        font-weight: 700;
    }

    .blog__content .blog-tag span,
    .blog-nine__content .blog-tag span,
    .blog-two__content .blog-tag span {
        font-size: 12px;
        line-height: 16px;
    }

    .blog__content .blog-info,
    .blog-nine__content .blog-info,
    .blog-two__content .blog-info {
        display: flex;
        align-items: center;
        gap: 22px;
    }
    ...
    .blog-nine__content .blog-info li,
    .blog-two__content .blog-info li {
        display: flex;
        align-items: center;
        gap: 8px;
    }
    ...
    .blog-nine__content .blog-info li a,
    .blog-two__content .blog-info li a {
        color: var(--paragraph);
        font-size: 14px;
        line-height: 22px;
    }
    ...
    .blog-nine__content .blog-info li a:hover,
    .blog-two__content .blog-info li a:hover {
        color: var(--primary-color);
    }
    ...
    .blog-nine__item .read-more-btn,
    .blog-three__grid-item .read-more-btn,
    .blog-two__item .read-more-btn {
        color: var(--paragraph);
    }

    .blog__item:hover .read-more-btn,
    .blog-nine__item:hover .read-more-btn,
    .blog-three__grid-item:hover .read-more-btn,
    .blog-two__item:hover .read-more-btn {
        color: var(--primary-color);
    }

    .blog__item:hover .read-more-btn i,
    .blog-nine__item:hover .read-more-btn i,
    .blog-three__grid-item:hover .read-more-btn i,
    .blog-two__item:hover .read-more-btn i {
        color: var(--primary-color);
        margin-left: 10px;
    }

    .blog__item:hover .blog__image img,
    .blog-nine__item:hover .blog__image img,
    .blog-three__grid-item:hover .blog__image img,
    .blog-two__item:hover .blog__image img {
    ...
    .coming-soon__wrp .btn-one,
    .coming-soon__wrp .btn-one-light,
    .coming-soon__wrp .event-five__content .event-five-btn,
    .event-five__content .coming-soon__wrp .event-five-btn {
    ...
    .footer__shape-left,
    .footer-two__shape-left,
    .footer-three__shape-left,
    .footer-four__shape-left,
    ...
    .event-details__item-right .item .share .footer-title,
    .courses-details__item-right .item .share .footer-title,
    .team-details__social .footer-title {
        margin-bottom: 30px;
        color: var(--heading-color);
        font-weight: 700;
    }
    ...
    .event-details__item-right .item .share ul li:not(:last-child),
    .courses-details__item-right .item .share ul li:not(:last-child),
    .team-details__social ul li:not(:last-child) {
        margin-bottom: 15px;
    }

    .footer__item ul li a,
    .event-details__item-right .item .share ul li a,
    .courses-details__item-right .item .share ul li a,
    ...
    .event-details__item-right .item .share ul li a:hover,
    .courses-details__item-right .item .share ul li a:hover,
    .team-details__social ul li a:hover {
        color: var(--primary-color);
    }

    .footer__item p,
    .event-details__item-right .item .share p,
    .courses-details__item-right .item .share p,
    .team-details__social p {
        color: var(--heading-color);
        opacity: 0.8;
    }

    .footer__item .social-icons a,
    .event-details__item-right .item .share .social-icons a,
    .courses-details__item-right .item .share .social-icons a,
    .team-details__social .social-icons a {
        width: 36px;
        height: 36px;
        line-height: 36px;
        text-align: center;
    ...
    .event-details__item-right .item .share .social-icons a:hover,
    .courses-details__item-right .item .share .social-icons a:hover,
    .team-details__social .social-icons a:hover {
        color: var(--white);
        background-color: var(--primary-color);
    }

    .footer__item .get-app a,
    .event-details__item-right .item .share .get-app a,
    .courses-details__item-right .item .share .get-app a,
    .team-details__social .get-app a {
        margin-right: 3px;
    }

    .footer__item.footer-about,
    .event-details__item-right .item .footer-about.share,
    .courses-details__item-right .item .footer-about.share,
    .footer-about.team-details__social {
        max-width: 293px;
        width: 100%;
    }

    .footer__item.footer-subscribe,
    .event-details__item-right .item .footer-subscribe.share,
    .courses-details__item-right .item .footer-subscribe.share,
    .footer-subscribe.team-details__social {
        max-width: 270px;
        width: 100%;
    }

    .footer__item.footer-touch,
    .event-details__item-right .item .footer-touch.share,
    .courses-details__item-right .item .footer-touch.share,
    .footer-touch.team-details__social {
        max-width: 270px;
        width: 100%;
    }

    .footer__item.item-sm,
    .event-details__item-right .item .item-sm.share,
    .courses-details__item-right .item .item-sm.share,
    .item-sm.team-details__social {
        max-width: 175px;
        width: 100%;
    }

    .footer__item.newsletter-six,
    .event-details__item-right .item .newsletter-six.share,
    .courses-details__item-right .item .newsletter-six.share,
    .newsletter-six.team-details__social {
        max-width: 299px;
        width: 100%;
    }

    .footer__item .footer-newsletter input,
    .footer__item .footer-newsletter__six input,
    .event-details__item-right .item .share .footer-newsletter input,
    .event-details__item-right .item .share .footer-newsletter__six input,
    .courses-details__item-right .item .share .footer-newsletter input,
    .courses-details__item-right .item .share .footer-newsletter__six input,
    .team-details__social .footer-newsletter input,
    .team-details__social .footer-newsletter__six input {
        width: 100%;
        padding: 13px 15px;
    }

    .footer__item .footer-newsletter button,
    .footer__item .footer-newsletter__six button,
    .event-details__item-right .item .share .footer-newsletter button,
    .event-details__item-right .item .share .footer-newsletter__six button,
    .courses-details__item-right .item .share .footer-newsletter button,
    .courses-details__item-right .item .share .footer-newsletter__six button,
    .team-details__social .footer-newsletter button,
    .team-details__social .footer-newsletter__six button {
        width: 100%;
        padding: 13px 15px;
        background: var(--primary-color);
        color: var(--white);
    ...
    .footer__item .footer-newsletter button:hover,
    .footer__item .footer-newsletter__six button:hover,
    .event-details__item-right .item .share .footer-newsletter button:hover,
    .event-details__item-right .item .share .footer-newsletter__six button:hover,
    .courses-details__item-right .item .share .footer-newsletter button:hover,
    .courses-details__item-right .item .share .footer-newsletter__six button:hover,
    .team-details__social .footer-newsletter button:hover,
    .team-details__social .footer-newsletter__six button:hover {
    ...
    .footer__item .footer-newsletter__six,
    .event-details__item-right .item .share .footer-newsletter__six,
    .courses-details__item-right .item .share .footer-newsletter__six,
    .team-details__social .footer-newsletter__six {
        position: relative;
        z-index: 1;
    }
    ...
    .mean-container .mean-nav ul li a button {
        color: #FFF9F7;
    }
    ...
    .form-bground {
        border: 0px;
        background-color: rgb(243 242 242 / 95%);
    }
    ...
    /* ظهور النقطة الداخلية عند التحديد */
...
.profile-placeholder {
    ...
    /* Store identity cleanup and readable contrast pass */
    :root {
        --text-strong: #2C1830;
        --text-readable: #465044;
        --text-muted: #735C68;
        --text-soft: #6E625B;
        --accent-readable: #B88A5A;
        --surface-cream: #FFF9F7;
        --surface-soft: #FFF4EF;
        --surface-beige: #F7DDE6;
        --text-on-dark: #FFF4EF;
        --text-on-dark-muted: rgba(255, 249, 239, 0.88);
    }
    ...
    .btn-one:hover,
    .menu-btns a.active:hover,
    .sidebar__btns .sign-in:hover {
    ...
    .banner-inner-area {
        ...
        background-image:
            linear-gradient(90deg, rgba(75, 33, 63, 0.055) 1px, transparent 1px),
            linear-gradient(180deg, rgba(75, 33, 63, 0.055) 1px, transparent 1px),
            linear-gradient(135deg, #FFF4EF 0%, #FFF9F7 46%, #F7DDE6 100%) !important;
        background-size: 52px 52px, 52px 52px, 100% 100% !important;
        color: var(--text-readable);
    }

    .banner-inner-area::before,
    ...
    .banner-inner-area::before {
        inset: 32px 48px;
        border: 1px solid rgba(143, 175, 139, 0.28);
        border-radius: 18px;
    }
    ...
    .banner-inner-area::after {
        ...
        border: 1px solid rgba(207, 166, 160, 0.46);
        border-radius: 8px;
        background:
            repeating-linear-gradient(90deg, rgba(143, 175, 139, 0.18) 0 1px, transparent 1px 14px),
            rgba(255, 252, 246, 0.55);
        transform: rotate(-4deg);
    }

    .banner-inner-area > .container,
    .banner-inner__content {
        position: relative;
        z-index: 1;
    }
    ...
    .contact-area::before {
        ...
        height: 100%;
        background: repeating-linear-gradient(135deg, rgba(143, 175, 139, 0.14) 0 2px, transparent 2px 18px);
        opacity: 0.56;
        pointer-events: none;
    }
    ...
    .contact__item {
        background-color: var(--surface-cream);
        border: 1px solid #EAD1DA;
        box-shadow: 0 22px 55px rgba(75, 33, 63, 0.08);
    }
    ...
    .contact__info .item svg path {
        fill: var(--accent-readable);
    }
    ...
    .store-policy-page::after {
        ...
        height: 160px;
        border: 1px solid rgba(143, 175, 139, 0.22);
        border-radius: 8px;
    ...
    .store-contact-page > .container,
    .store-policy-page > .container {
        position: relative;
        z-index: 1;
    }

    .store-contact-page .contact__info {
        padding-bottom: 36px !important;
    }

    .store-contact-page .contact__info .item {
        position: relative;
        min-height: 210px;
        padding: 30px;
        text-align: start;
        ...
        border-radius: 8px;
        background:
            linear-gradient(135deg, rgba(143, 175, 139, 0.12), transparent 42%),
            #FFF9F7;
        box-shadow: 0 22px 55px rgba(75, 33, 63, 0.09);
    }

    .store-contact-page .contact__info .item svg {
        display: none;
    }

    .store-contact-page .contact__info .item::before {
        display: inline-flex;
        align-items: center;
        justify-content: center;
        width: 54px;
        ...
        font-size: 22px;
        font-weight: 700;
        box-shadow: 0 14px 30px rgba(75, 33, 63, 0.16);
    }

    .store-contact-page .contact__info .row > div:nth-child(1) .item::before {
        content: "\f0e0";
    }

    .store-contact-page .contact__info .row > div:nth-child(2) .item::before {
        content: "\f095";
    }

    .store-contact-page .contact__info .item h3 {
        color: #2C1830;
        font-size: 24px;
        font-weight: 900;
    ...
    .store-contact-page .contact__info .item p {
        color: #735C68;
        font-size: 16px;
        font-weight: 600;
    }

    .store-contact-page .contact__item {
        padding: 34px;
        border: 1px solid #EAD1DA;
        border-radius: 8px;
        background: #FFF9F7;
        box-shadow: 0 24px 60px rgba(75, 33, 63, 0.10);
    }

    .store-contact-page .contact__item .section-header h5 {
        display: inline-flex;
        align-items: center;
        gap: 10px;
        padding: 8px 12px;
    ...
    .store-contact-page .contact__item form label {
        color: #2C1830;
        font-weight: 800;
    }

    .store-contact-page .contact__item form input,
    .store-contact-page .contact__item form textarea,
    .store-contact-page .contact__item form select,
    .store-contact-page .select2-container--default .select2-selection--single {
        border-radius: 8px;
        border-color: #D9C8B5 !important;
        background: #FFF4EF !important;
        color: #2C1830 !important;
    }

    .store-contact-page .select2-container {
        width: 100% !important;
        margin-bottom: 25px;
    }

    .store-contact-page .btn-one {
        min-width: 150px;
        min-height: 50px;
        justify-content: center;
        background: #4B213F !important;
    ...
    .store-policy-layout.no-image {
        max-width: 980px;
        margin: 0 auto;
    }

    .store-policy-layout.has-image {
    ...
    .store-policy-content h1,
    .store-policy-content h2,
    .store-policy-content h3,
    .store-policy-content h4 {
        margin: 24px 0 12px;
        color: #2C1830;
    }

    .store-policy-content ul,
    .store-policy-content ol {
        padding-inline-start: 22px;
        margin: 16px 0;
    }

    .store-policy-content a {
        color: #B88A5A;
        font-weight: 900;
    ...
    .store-product-detail-page::before {
        content: "";
        position: absolute;
        inset-inline-start: 6%;
        top: 72px;
        ...
        border-radius: 8px;
        background:
            linear-gradient(135deg, rgba(255, 252, 246, 0.76), rgba(244, 235, 221, 0.26)),
            repeating-linear-gradient(135deg, rgba(143, 175, 139, 0.16) 0 1px, transparent 1px 18px);
        pointer-events: none;
    ...
    .store-products-count {
        ...
        font-weight: 900;
        text-align: center;
        box-shadow: 0 14px 32px rgba(75, 33, 63, 0.08);
    }
    ...
    .store-product-card {
        ...
        height: 100%;
        padding: 0 !important;
        border: 1px solid #EAD1DA !important;
        border-radius: 8px !important;
        background: #FFF9F7 !important;
        box-shadow: 0 22px 54px rgba(75, 33, 63, 0.10);
        overflow: hidden;
    ...
    .store-product-card:hover {
        ...
        box-shadow: 0 30px 70px rgba(75, 33, 63, 0.14);
        transform: perspective(900px) rotateX(1.4deg) translateY(-6px);
    }
    ...
    .store-product-card__media::after {
        content: "";
        position: absolute;
        inset: auto 0 0 0;
        height: 45%;
        background: linear-gradient(180deg, transparent, rgba(75, 33, 63, 0.44));
        opacity: 0.88;
        pointer-events: none;
    }

    .store-product-card__media a,
    ...
    .store-product-card__meta {
        ...
        border-bottom: 1px solid #EAD1DA;
    }

    .store-product-card__meta h4 {
        margin: 0;
        color: #B88A5A !important;
        font-size: 17px;
        line-height: 1.45;
    ...
    .store-product-card .cartBut {
        ...
        height: 46px;
        min-width: 46px;
        border: 1px solid rgba(75, 33, 63, 0.12);
        border-radius: 8px;
        background: #4B213F;
        color: #FFF4EF;
        box-shadow: 0 12px 24px rgba(75, 33, 63, 0.16);
    }

    .store-product-card .cartBut i {
        color: #FFF4EF;
        font-size: 17px;
    }
    ...
    .store-product-detail-heading {
        padding: clamp(24px, 4vw, 38px) !important;
        border: 1px solid #EAD1DA !important;
        border-radius: 8px;
        background:
            linear-gradient(135deg, rgba(143, 175, 139, 0.12), transparent 44%),
            #FFF9F7;
        box-shadow: 0 24px 60px rgba(75, 33, 63, 0.10);
    }

    .store-product-detail-heading h3 {
        color: #2C1830;
    ...
    .store-product-heading-price span {
        display: block;
        margin-bottom: 6px;
        color: #735C68;
        font-size: 14px;
    ...
    .store-product-heading-price strong {
        display: block;
        color: #2C1830;
        font-size: 24px;
        line-height: 1.2;
    ...
    .store-product-tabs ul.nav {
        gap: 10px;
        padding: 0;
        border: 0;
    }

    .store-product-tabs ul.nav li a {
        display: inline-flex;
        align-items: center;
        justify-content: center;
        min-height: 48px;
        padding: 12px 18px !important;
        border: 1px solid #D9C8B5 !important;
        border-radius: 8px !important;
        background: #FFF9F7 !important;
        color: #2C1830 !important;
        font-size: 16px;
    ...
    .store-product-tabs ul.nav li a.active,
    .store-product-tabs ul.nav li a:hover {
        border-color: #4B213F !important;
        background: #4B213F !important;
        color: #FFF4EF !important;
    }
    ...
    .store-product-tab-content {
        ...
        border-radius: 8px;
        background: #FFF9F7;
        box-shadow: 0 24px 60px rgba(75, 33, 63, 0.09);
    }
    ...
    .store-product-gallery {
        ...
        background: #F7DDE6;
        overflow: hidden;
        box-shadow: inset 0 0 0 1px rgba(255, 252, 246, 0.62);
    }

    .store-product-gallery .carousel-inner,
    .store-product-gallery .carousel-item {
        border-radius: 8px;
    }
    ...
    .store-product-gallery .carousel-control-prev,
    .store-product-gallery .carousel-control-next {
        width: 54px;
        height: 54px;
        top: 50%;
        margin-inline: 16px;
        ...
        border-radius: 8px;
        background: rgba(75, 33, 63, 0.82);
        transform: translateY(-50%);
        opacity: 1;
    }

    .store-product-gallery .carousel-control-prev:hover,
    .store-product-gallery .carousel-control-next:hover {
        background: #4B213F;
    }
    ...
    .store-product-thumbs img:hover {
        border-color: #B88A5A;
        opacity: 1;
    ...
    .store-product-detail-copy p,
    .store-product-detail-copy li {
    ...
    .store-product-detail-copy h1,
    .store-product-detail-copy h2,
    .store-product-detail-copy h3,
    .store-product-detail-copy h4 {
        color: #2C1830 !important;
        font-weight: 900;
    }

    .store-product-detail-copy a {
        color: #B88A5A;
        font-weight: 900;
        text-decoration: underline;
    }

    .store-product-detail-page .courses-details__item-right {
        position: sticky;
        top: 108px;
    }

    .store-product-detail-page .courses-details__item-right .item {
        padding: clamp(22px, 3vw, 30px);
        border: 1px solid #EAD1DA;
        border-radius: 8px;
        background:
            linear-gradient(180deg, rgba(143, 175, 139, 0.10), transparent 28%),
            #FFF9F7;
        box-shadow: 0 24px 60px rgba(75, 33, 63, 0.12);
    }

    .store-purchase-card form {
        display: grid;
        gap: 14px;
    }

    .store-purchase-card h2 {
        margin: 0;
        color: #2C1830;
        font-size: 18px;
        font-weight: 900;
    ...
    .store-purchase-card hr {
        margin: 0;
        border-color: #EAD1DA;
        opacity: 1;
    }

    .store-purchase-card label.custom-control {
        display: flex;
        align-items: center;
        gap: 10px;
        width: 100%;
    ...
    .store-purchase-card .overflow-control-description {
        color: #2C1830;
        font-weight: 800;
        line-height: 1.6;
    }

    .store-purchase-card p {
    ...
    .store-product-detail-page .courses-details__item-right .item .price {
        display: block;
        margin: 22px 0 14px;
        padding: 18px;
        border: 1px solid #D9C8B5;
    ...
    .store-purchase-card .btn-one,
    .store-purchase-card .btn-one2 {
    ...
    .store-purchase-card .btn-one:hover,
    .store-purchase-card .btn-one2:hover {
        background: #B88A5A !important;
        color: #FFF4EF !important;
    }

    .store-purchase-card .btn-one i,
    .store-purchase-card .btn-one2 i {
        color: #FFF4EF !important;
    }

    .store-purchase-card .notAvailable {
        display: block;
        padding: 14px 16px;
        border: 1px solid rgba(207, 166, 160, 0.5);
        border-radius: 8px;
        background: rgba(207, 166, 160, 0.14);
        color: #6D3F3A;
        font-weight: 900;
        text-align: center;
    }
    ...
    .store-category-page .container {
        position: relative;
        z-index: 1;
    }

    .store-category-page .section-header h5 {
        display: inline-flex;
        align-items: center;
        gap: 10px;
        margin-bottom: 16px;
    ...
    .store-category-page .section-header p {
        max-width: 760px;
        margin-inline: auto;
        color: #465044 !important;
        font-size: 18px;
    ...
    .store-category-card .topic__icon {
        display: inline-flex;
        align-items: center;
        justify-content: center;
        width: 58px;
    ...
    .store-category-card .topic__icon svg,
    .store-category-card .topic__icon i {
        width: 28px;
        height: 28px;
        color: #FFF4EF !important;
    }

    .store-category-card .topic__icon svg path {
        fill: #FFF4EF !important;
    }

    .store-category-card .topic__content h4,
    .store-category-card .topic__content h4 a {
        color: #2C1830 !important;
        font-size: 22px;
        line-height: 1.45;
        font-weight: 900;
    ...
    .footer-two-area {
        margin-top: 0;
        background-color: #2C1830 !important;
        background-image:
            linear-gradient(135deg, rgba(255, 249, 239, 0.07) 0%, rgba(255, 249, 239, 0) 42%),
            linear-gradient(90deg, rgba(255, 249, 239, 0.045) 1px, transparent 1px),
            linear-gradient(180deg, rgba(255, 249, 239, 0.04) 1px, transparent 1px) !important;
    ...
    .footer-two-area::before {
        ...
        height: 1px;
        background: linear-gradient(90deg, transparent, rgba(255, 249, 239, 0.26), transparent);
        pointer-events: none;
    }

    .footer-two-area .container,
    .footer-two-area .footer__copyright {
        position: relative;
        z-index: 1;
    }
    ...
    .footer-two-area .footer__item .footer-title span {
        color: #FFF4EF !important;
        font-size: 22px;
        margin-bottom: 18px;
    }

    .footer-two-area .footer__item p,
    .footer-two-area .footer__item p *,
    .footer-two-area .footer__item ul li {
        color: rgba(255, 249, 239, 0.84) !important;
        opacity: 1;
    }

    .footer-two-area .footer__item ul li a,
    .footer-two-area .footer__item ul li a span {
        color: #FFF4EF !important;
        opacity: 1;
    }

    .footer-two-area .footer__item ul li svg path,
    .footer-two-area .footer__item ul li i {
        color: #B88A5A;
        fill: #B88A5A;
    }
    ...
    .footer-two-area .footer__copyright p,
    .footer-two-area .footer__copyright p *,
    .footer-two-area .footer__copyright a,
    .footer-two-area .footer__copyright a span {
        color: rgba(255, 249, 239, 0.9) !important;
        opacity: 1;
    }

    .footer-two-area .footer__copyright ul {
        gap: 14px !important;
    }

    .footer-two-area .footer__copyright ul a {
        padding: 7px 10px;
        border-radius: 8px;
    ...
    .contestWidth {
        ...
        background: #FFF4EF;
        object-fit: contain;
        filter: grayscale(1) sepia(0.18) saturate(0.9) hue-rotate(55deg) brightness(0.94);
        opacity: 1;
    }

    a:hover .contestWidth {
        filter: grayscale(1) sepia(0.34) saturate(1) hue-rotate(55deg) brightness(0.82);
        transform: translateY(-2px);
    }
    ...
    .header-area.menu-fixed {
        background: #FFF9F7 !important;
        border-bottom: 1px solid #EAD1DA;
        box-shadow: 0 16px 42px rgba(75, 33, 63, 0.13) !important;
        backdrop-filter: none;
    }

    .header-area.menu-fixed.animated {
    ...
    .header__main .main-menu nav > ul,
    .header__main .main-menu ul li {
        overflow: visible;
    }

    .header__main .main-menu nav > ul > li > .sub-menu,
    .header__main .main-menu ul li .sub-sub-menu {
        display: flex !important;
        min-width: 230px;
        padding: 10px;
        ...
        border-radius: 8px;
        background: #FFF9F7;
        box-shadow: 0 24px 60px rgba(75, 33, 63, 0.16);
        pointer-events: none;
        z-index: 10020;
    }
    ...
    .header__main .main-menu ul li .sub-menu li a,
    .header__main .main-menu ul li .sub-menu li a span,
    .header__main .main-menu ul li .sub-sub-menu li a,
    .header__main .main-menu ul li .sub-sub-menu li a span {
        color: #2C1830 !important;
    }
    ...
    .header__main .main-menu ul li .sub-menu li:hover > a,
    .header__main .main-menu ul li .sub-menu li:hover > a span,
    .header__main .main-menu ul li .sub-sub-menu li:hover > a,
    .header__main .main-menu ul li .sub-sub-menu li:hover > a span {
        color: #FFF4EF !important;
    }
    ...
    .header__main .main-menu nav > ul > li:hover > .sub-menu,
    .header__main .main-menu nav > ul > li:focus-within > .sub-menu,
    .header__main .main-menu nav > ul > li.is-open > .sub-menu,
    .header__main .main-menu ul li:hover > .sub-sub-menu,
    .header__main .main-menu ul li:focus-within > .sub-sub-menu,
    .header__main .main-menu ul li.is-open > .sub-sub-menu {
        opacity: 1;
        visibility: visible;
        pointer-events: auto;
        transform: translateY(0);
    ...
    .header__main .main-menu ul li:hover > a > i,
    .header__main .main-menu ul li.is-open > a > i,
    .header__main .main-menu ul li:focus-within > a > i {
        transform: rotate(-180deg);
        color: #B88A5A;
    }

    body.lang-en .header__main .main-menu nav > ul > li > .sub-menu {
        left: 0;
        right: auto;
    }

    body.lang-en .header__main .main-menu ul li .sub-sub-menu {
        left: calc(100% - 8px);
        right: auto;
    }
    ...
    @media (max-width: 767px) {
        ...
        .footer-two-area .footer__copyright .d-flex {
            gap: 14px !important;
        }

        .contact-area > .container > .row,
        .contact-area .contact__info > .row {
            --bs-gutter-x: 0;
        ...
        .contact-area .contact__info > .row > [class*="col-"] {
        ...
        .store-contact-page .form-box .col-6,
        .store-policy-layout.has-image {
            width: 100%;
            grid-template-columns: 1fr;
        }
        ...
        .store-products-toolbar,
        .store-product-detail-heading > .d-flex {
    ...
    .sidebar-area {
        background:
            radial-gradient(circle at 92% 4%, rgba(217, 137, 163, 0.28), transparent 34%),
            linear-gradient(160deg, rgba(75, 33, 63, 0.98), rgba(55, 20, 53, 0.98));
        color: var(--text-on-dark);
        overflow-x: hidden;
    }
    ...
    .sidebar-area.offcanvas {
        ...
        border-left: 4px solid rgba(217, 137, 163, 0.84) !important;
        box-shadow: -24px 0 60px rgba(42, 15, 39, 0.32);
    }
    ...
    .sidebar-area .btn-close {
        ...
        width: 58px;
        height: 58px;
        border: 1px solid rgba(255, 249, 247, 0.36);
        border-radius: 50%;
        color: #FFF9F7;
        background: #D989A3;
        box-shadow: 0 14px 34px rgba(217, 137, 163, 0.32);
        opacity: 1;
    }

    .sidebar-area .btn-close i {
        color: inherit;
        font-size: 28px;
    }

    .sidebar-area .ty-sidebar-brand {
        display: inline-flex;
        align-items: center;
        justify-content: center;
        flex: 1 1 auto;
        ...
        min-height: 78px;
        padding: 10px 16px;
        border: 1px solid rgba(255, 249, 247, 0.56);
        border-radius: 22px;
        background: rgba(255, 249, 247, 0.94);
        box-shadow: 0 22px 46px rgba(37, 12, 34, 0.22);
        overflow: hidden;
    }

    .sidebar-area .ty-sidebar-brand img {
        display: block;
        width: 100%;
        max-width: 218px;
        max-height: 62px;
    ...
    .ty-mobile-nav a {
        ...
        min-height: 54px;
        padding: 12px 16px;
        border: 1px solid rgba(255, 249, 247, 0.16);
        border-radius: 16px;
    ...
    .ty-mobile-nav a span,
    .sidebar-area .sidebar__btns .sign-in span,
    .ty-mobile-logout button span {
        color: inherit !important;
    }

    .ty-mobile-nav a:hover {
        background: rgba(255, 249, 247, 0.14);
        color: #FFF9F7 !important;
    }
    ...
    .sidebar-area .sidebar__search input {
        ...
        border: 1px solid rgba(255, 249, 247, 0.58) !important;
        border-radius: 18px;
        color: #4B213F !important;
        background: rgba(255, 249, 247, 0.96) !important;
        font-size: 17px;
        font-weight: 700;
        box-shadow: 0 16px 34px rgba(37, 12, 34, 0.20);
    }

    .sidebar-area .sidebar__search button {
        top: 50%;
        right: 18px;
        transform: translateY(-50%);
        color: #4B213F;
    ...
    .sidebar-area .sidebar-language {
        display: inline-flex;
        margin-top: 18px;
        padding: 7px;
        border: 1px solid rgba(255, 249, 247, 0.5);
        background: rgba(255, 249, 247, 0.94);
        box-shadow: 0 16px 36px rgba(37, 12, 34, 0.22);
    }

    .sidebar-area .sidebar__btns {
        display: flex;
        align-items: center;
        justify-content: flex-start;
        gap: 12px;
    ...
    .sidebar-area .sidebar__btns .sign-in,
    .ty-mobile-logout button {
        display: inline-flex;
        align-items: center;
        justify-content: center;
        min-height: 54px;
        padding: 12px 22px;
        border: 1px solid rgba(255, 249, 247, 0.14);
        border-radius: 16px;
        color: #FFF9F7 !important;
        background: rgba(69, 23, 58, 0.9) !important;
        box-shadow: 0 16px 34px rgba(37, 12, 34, 0.20);
        font-size: 18px;
        font-weight: 800;
    }
    ...
    .ty-header-action {
        ...
        margin: 0 !important;
        padding: 0 !important;
        border: 1px solid rgba(217, 137, 163, 0.34) !important;
        border-radius: 18px !important;
        color: #4B213F !important;
        background:
            linear-gradient(145deg, rgba(255, 255, 255, 0.94), rgba(255, 244, 239, 0.76)) !important;
        box-shadow: 0 14px 32px rgba(75, 33, 63, 0.10), inset 0 1px 0 rgba(255, 255, 255, 0.82);
        text-decoration: none;
    }
    ...
    .ty-header-action:hover {
        color: #FFF9F7 !important;
        border-color: rgba(75, 33, 63, 0.22) !important;
        background: #4B213F !important;
    }

    .ty-cart-action__icon {
        display: inline-flex;
        align-items: center;
        justify-content: center;
        width: 30px;
        height: 30px;
        border-radius: 50%;
        background: rgba(217, 137, 163, 0.16);
    }

    .ty-cart-action__count {
        position: absolute;
        top: -7px;
        ...
        color: #FFF9F7 !important;
        background: #D989A3;
        box-shadow: 0 10px 20px rgba(75, 33, 63, 0.18);
        font-size: 12px;
        font-weight: 900;
        line-height: 1;
    }
