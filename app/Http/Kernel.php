...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'infoConfirm' => \App\Http\Middleware\InfoConfirm::class,
        'MarketerSurvey' => \App\Http\Middleware\MarketerSurvey::class,
        'auth.customer' => \App\Http\Middleware\AuthenticateCustomer::class,
        'auth.web' => \App\Http\Middleware\AuthenticateAdmin::class,
    ];
}
